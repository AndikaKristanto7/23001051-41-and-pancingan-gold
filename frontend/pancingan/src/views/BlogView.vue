  ...
  <div class="new-blog container">
    <div class="form">
      <b-form @submit="onSubmit" >
        ...
        <div class="row">
          <div class="col-md-12">
            <b-alert variant="success" v-model="successAlert" dismissible>Success update blog!</b-alert>
        ...
        <b-row class="mb-3">
            ...
            <b-col cols="2">
              <b-button type="button" variant="danger" @click="deleteBlog()">Delete Blog</b-button>
            </b-col>
        </b-row>
      </b-form>
    </div>
...
export default {
  ...
  methods :{
    async getBlogDataBySlug(){
        await BeApp.getBlogBySlug(this.$route.params.slug)
        .then((data)=>{
          let resp = data.data.data
          this.form = resp
          this.title = this.form.title
          this.markers[0] = {position : JSON.parse(this.form.location)}
        })
        .catch(()=>{
    ...
    onSubmit(event) {
        ...
        BeApp.updateBlogBySlug(this.$route.params.slug,this.form)
        .then(()=>{
      ...
      showAlertConfirm(){
            return this.$swal({
              ...
              if (result.value) {
                BeApp.deleteBlogBySlug(this.$route.params.slug)
                this.$swal(
                  'Deleted!',
